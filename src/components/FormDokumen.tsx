...
export default function FormDokumen({
  ...
  const validateAndSubmit = () => {
    if (
      ...
      setErrorLocal('Mohon lengkapi seluruh dokumen pendukung (KTP, KK, Surat Putusan, Surat Keterangan, Surat Pimpinan/Guru) dan Masa Jabatan sebelum submit.');
      return;
    }
    ...
    if (isNaN(startYear) || isNaN(endYear) || startYear > endYear || startYear < 2000 || endYear > 2099) {
      setErrorLocal('Masa jabatan tidak valid. Tahun berakhir harus setelah atau sama dengan tahun berlaku.');
      return;
    }
        ...
        <div className={styles.alertHeader}>
          ...
          <div>
            ...
            <p className={styles.alertSubtitle}>
              Upload semua dokumen yang diperlukan dalam format JPG/PNG (Maks. 1MB)
            </p>
          </div>
        </div>
        ...
        <div className={styles.cardBody}>
          ...
          <div className={styles.grid}>
            ...
            <div className={styles.uploadCard}>
              ...
              <h4 className={styles.docTitle}>Masa Jabatan</h4>
